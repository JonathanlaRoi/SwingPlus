...
public abstract class JPFormListView<T> extends JPModeledPanel<List<T>> implements JPFormComponent<List<T>>, JPEditable {
    ...
    public void setEditable(boolean editable) {
        items.forEach(i -> {
            if (i instanceof JPFormContainer) {
                ((JPFormContainer) i).setEditable(editable);
            } else if (i instanceof Component) {
                ((Component) i).setEnabled(editable);
            }
        });
    }
