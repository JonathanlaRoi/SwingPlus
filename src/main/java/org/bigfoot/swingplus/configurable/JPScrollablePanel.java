 ...
 */
public class JPScrollablePanel extends JPPanel implements Scrollable, SwingConstants{
	 ...
	 */
	public JPScrollablePanel(LayoutManager layout)
	{
		super( layout );
